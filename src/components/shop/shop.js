...
import * as shopAction from "../../actions/shop.action";
          ...
          <tr>
            <td className="td_orderline">
              ...
              <div>
                ...
                <br />
                {item.qty} pcs.
                <span style={{marginTop:20,marginRight:20,float:'right'}} onClick={()=>this.props.removeOrder(item)}>
